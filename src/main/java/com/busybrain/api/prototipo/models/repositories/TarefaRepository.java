...
public interface TarefaRepository extends CrudRepository<Tarefa, Integer>{
    ...
    String queryByTaskCardview = "select tarefas.task_id AS taskId, tarefas.task_title AS taskTitle, tarefas.task_desc AS taskDesc, priority.taskpriority_type AS prioridade " +
